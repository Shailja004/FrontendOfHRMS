...
export class Round1Component  implements OnInit, OnDestroy {
  ...
  constructor(public router: Router, private viewformService: ViewformService, private activatedRoutes: ActivatedRoute, private route: ActivatedRoute) {}
  ngOnDestroy(): void {
